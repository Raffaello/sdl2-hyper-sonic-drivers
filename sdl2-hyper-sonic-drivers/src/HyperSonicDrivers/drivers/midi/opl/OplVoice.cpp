...
OplVoice::OplVoice(const uint8_t slot, const drivers::opl::OplWriter* oplWriter) : m_oplWriter(oplWriter), m_slot(slot)
{
}
...
void OplVoice::pause() const noexcept
{
    ...
    m_oplWriter->writeChannel(0x80, m_slot, m_instr->sust_rel_1 & 0xF0,
