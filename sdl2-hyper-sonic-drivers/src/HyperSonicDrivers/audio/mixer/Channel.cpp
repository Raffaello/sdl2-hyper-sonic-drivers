...
{
Channel::Channel(IMixer& mixer, const uint8_t id) : m_mixer(mixer), m_id(id)
{
}
...
void Channel::setAudioStream(const mixer::eChannelGroup group, const std::shared_ptr<IAudioStream>& stream, const uint8_t volume, const int8_t pan, const bool reverseStereo)
{
