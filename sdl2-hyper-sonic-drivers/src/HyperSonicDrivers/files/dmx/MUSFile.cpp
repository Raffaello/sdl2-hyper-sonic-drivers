...
namespace HyperSonicDrivers::files::dmx
{
    ...
    constexpr int MUS_SECONDARY_CHANNELS = 16 - MUS_PRIMARY_CHANNELS;
    constexpr int MUS_PERCUSSION_CHANNEL = 15;
    ...
    void MUSFile::readHeader()
    {
        ...
        assertValid_(_header.secondary_channels <= MUS_SECONDARY_CHANNELS);
    ...
    std::shared_ptr<audio::MIDI> MUSFile::convertToMidi()
    {
        ...
        for (auto &event : _mus)
        {
            ...
            {
            case MUS_EVENT_TYPE_RELEASE_NOTE:
                me.type._.high = static_cast<uint8_t>(MIDI_EVENT_TYPES_HIGH::NOTE_OFF);
                me.data.push_back(event.data[0]);
                me.data.push_back(MUS_NOTE_VELOCITY_DEFAULT);
                break;
            case MUS_EVENT_TYPE_PLAY_NOTE:
                me.type._.high = static_cast<uint8_t>(MIDI_EVENT_TYPES_HIGH::NOTE_ON);
                me.data.push_back(event.data[0]);
                me.data.push_back(event.data[1]);
                break;
            case MUS_EVENT_TYPE_PITCH_BEND:
            {
                me.type._.high = static_cast<uint8_t>(MIDI_EVENT_TYPES_HIGH::PITCH_BEND);
            ...
            case MUS_EVENT_TYPE_SYS_EVENT:
                me.type._.high = static_cast<uint8_t>(MIDI_EVENT_TYPES_HIGH::CONTROLLER);
            ...
            case MUS_EVENT_TYPE_CONTROLLER:
                ...
                if (d1 == 0)
                {
                    ...
                    me.type._.high = static_cast<uint8_t>(MIDI_EVENT_TYPES_HIGH::PROGRAM_CHANGE);
                    me.data.push_back(d2);
            ...
            {
            case MUS_PERCUSSION_CHANNEL:
                me.type._.low = MIDI_PERCUSSION_CHANNEL;
                break;
            case MIDI_PERCUSSION_CHANNEL:
                me.type._.low = MUS_PERCUSSION_CHANNEL;
                break;
            default:
                me.type._.low = event.desc.e.channel;
                break;
            }
