...
namespace hardware
{
    namespace opl
    {
        ...
        OPLChipClass::OPLChipClass(const uintptr_t cnum) noexcept
        {
            // which OPL chip are we (needed for timers)
            chip_num = cnum;
        }

        void OPLChipClass::change_attackrate(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_decayrate(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_releaserate(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_sustainlevel(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_waveform(uintptr_t regbase, celltype* c)
        {
            // waveform selection
        ...
        void OPLChipClass::change_keepsustain(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_vibrato(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::change_feedback(uintptr_t chanbase, celltype* c)
        {
        ...
        void OPLChipClass::change_cellfreq(uintptr_t chanbase, uintptr_t regbase, celltype* c)
        {
            // frequency
        ...
        void OPLChipClass::cellon(uintptr_t regbase, celltype* c)
        {
        ...
        void OPLChipClass::adlib_init(intptr_t samplerate, bool highprec/*=false*/)
        {
            intptr_t i, j, oct;
        ...
        void OPLChipClass::adlib_write(uintptr_t idx, uint8_t val, uintptr_t second_set) {
...
#define CHANVAL_OUT                                 \
    outbufl[i] += chanval;
        ...
        void OPLChipClass::adlib_getsample(int16_t* sndptr, intptr_t numsamples) {
