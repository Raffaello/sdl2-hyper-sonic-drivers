    ...
    namespace midi
    {
        namespace scummvm
        {
            ...
            public:
                 ...
                 */
                static const uint8_t MAXIMUM_SOURCES = 10;
                /**
                 ...
                 */
                static const uint16_t DEFAULT_SOURCE_NEUTRAL_VOLUME = 255;

            protected:
                // Timeout between updates of the channel volume for fades (25ms)
                static const uint16_t FADING_DELAY = 25 * 1000;
            ...
            public:
                ...
                void send(int8_t source, uint32_t b) override = 0;
                 ...
                 */
                virtual void deinitSource(uint8_t source);
                /**
                 ...
                 */
                void setSourceVolume(uint8_t source, uint16_t volume);
                /**
                 ...
                 */
                void resetSourceVolume(uint8_t source);
                /**
                 ...
                 */
                void setSourceNeutralVolume(uint16_t volume);
                /**
                 ...
                 */
                void setSourceNeutralVolume(uint8_t source, uint16_t volume);
                 ...
                 */
                void startFade(uint16_t duration, uint16_t targetVolume);
                /**
                 ...
                 * @param targetVolume The volume at the end of the fade
                 */
                void startFade(uint8_t source, uint16_t duration, uint16_t targetVolume);
                /**
                 ...
                 * set to the target fade volume).
                 */
                void abortFade(uint8_t source, FadeAbortType abortType = FADE_ABORT_TYPE_END_VOLUME);
                /**
                 ...
                 */
                void setControllerDefault(ControllerDefaultType type, int16_t value);
                /**
                 ...
                 */
                virtual void stopAllNotes(uint8_t source, uint8_t channel) = 0;
            ...
            protected:
                 ...
                 */
                virtual void applySourceVolume(uint8_t source) = 0;
                /**
                ...
                // User volume settings
                uint16_t _userMusicVolume;
                uint16_t _userSfxVolume;
                bool _userMute;

                std::mutex _fadingMutex;
